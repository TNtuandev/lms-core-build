...
const feedbacks: Feedback[] = [
  {
    ...
    rating: 5,
    content:
      "Em thích Brainsploit lắm! Mấy bài học Java dễ hiểu kinh khủng, lại còn được tự tay code game nữa chứ. Giờ em thấy code không khó như em nghĩ tí nào!",
  },
  {
    name: "Khôi Nguyên",
    age: 12,
    ...
    rating: 5,
    content:
      "Thầy cô ở Brainsploit siêu dễ thương, mỗi khi em hỏi là được giải đáp ngay. Em còn làm được cả dự án thực tế, làm xong khoe với ba mẹ luôn!",
  },
  {
    name: "Mai Chi",
    age: 11,
