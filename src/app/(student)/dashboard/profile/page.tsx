...
function ProfilePage() {
  return (
    <Card className="bg-[#F7F2FC] border-0 rounded-xl shadow-sm">
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-6">
            <div className="space-y-2">
              ...
              <div className="text-gray-800 font-medium">25/04/2025 06:00 am</div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="text-gray-800 font-medium">chrishemsworth@gmail.com</div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="text-gray-800 font-medium">Nhà phát triển ứng dụng</div>
            </div>
