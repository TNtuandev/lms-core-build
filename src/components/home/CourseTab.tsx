      ...
      <div className="container mx-auto px-6 lg:px-20">
        <div className="text-center lg:text-left mb-16 space-y-2">
          <h2 className="text-2xl lg:text-5xl font-bold">
            <span className="bg-gradient-to-r from-[#6D5DFB] to-[#2CD4D9] text-transparent bg-clip-text">
              Khóa Học Java Đa Dạng
            </span>
          </h2>
          <h3 className="text-2xl lg:text-5xl font-extrabold text-[#0E0F1C] mb-4">
            Con Đường Dẫn Đến Thành Thạo!
          </h3>
          <p className="text-gray-600 max-w-2xl mt-4">
            Chúng mình đã xây dựng các khóa học Java đa dạng, được thiết kế đặc
            biệt để phù hợp với mọi trình độ và mục tiêu. Dù bạn mới bắt đầu hay
            muốn nâng cao kỹ năng, Brainsploit luôn có khóa học dành cho bạn!
          </p>
        </div>
            ...
            <button
              ...
              className={`cursor-pointer relative flex flex-col items-center justify-center min-w-[120px] px-8 py-4 rounded-full transition-all ${
                getActiveTabId() === tab.id
                  ? "bg-[#6A67F4] text-white"
                  : "text-[#6A67F4] bg-white border-[#6A67F4] hover:bg-[#6A67F4] hover:text-white"
              }`}
            >
        ...
        <div className="mt-8 flex justify-center">
          <Button onClick={handleNavigateToCourse} variant="outline" size="lg">
            Xem tất cả
            <ArrowRight className="w-4 h-4 see-all-course-button" />
          </Button>
        </div>
      </div>
    </section>
