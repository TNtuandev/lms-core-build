        ...
        <Row gutter={[32, 32]} align="middle">
          <Col xs={24} lg={12}>
            <div className="w-full flex justify-center">
              <Image
                src="/images/home/student-girl.png"
                alt="Student"
                width={500}
                height={600}
          ...
          <Col xs={24} lg={12}>
            <div className="space-y-6 text-center lg:text-left">
              <h2 className="text-3xl lg:text-5xl font-extrabold text-[#0E0F1C] leading-tight">
              ...
              <Button
                ...
                className="bg-[#6D5DFB] text-white px-6 py-2 rounded-full font-semibold text-sm shadow-md"
              >
                Bắt đầu miễn phí
              </Button>
            </div>
