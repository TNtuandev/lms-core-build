    ...
    <div className="flex w-full flex-col md:flex-row">
      ...
      <div className="flex flex-col justify-center items-center w-full px-6 md:px-8">
        ...
        <div className="flex gap-2 text-sm text-[#212B36]">
          ...
          <div className="text-[#2F57EF]">Đăng nhập</div>
        </div>
        <div className="w-full flex flex-col justify-center items-center gap-4 mt-[40px]">
          <div className="flex gap-4 w-full items-center">
            <input
              type="text"
              placeholder="Tên"
              className="w-full border border-gray-200 rounded-md px-4 py-2 h-12"
            />
            <input
              type="text"
              placeholder="Họ"
        ...
        <div className="text-center text-[#637381] text-xs mt-4">Bằng cách đăng ký, tôi đồng ý với</div>
        <div className="flex justify-center items-center w-full mt-1 gap-1">
          <div className="underline text-xs">Quên mật khẩu?</div>
          <div className="text-center text-[#637381] text-xs">và</div>
          <div className="underline text-xs">Điều khoản sử dụng</div>
        </div>
