      ...
      <div className="md:max-w-3xl max-w-sm lg:max-w-5xl xl:max-w-7xl mx-auto pt-16 pb-8 px-6 text-white">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <div className="mt-8 text-base">
              Brainsploit là nền tảng học tập trực tuyến hiện đại, mang đến trải
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="flex flex-col gap-2">
              <div className="text-xl font-semibold">Brainsploit</div>
              <Link
                href={Routes.abouts}
                className="md:mt-6 cursor-pointer hover:text-primary-main hover:underline"
              >
        ...
        <div className="flex flex-row gap-4 text-sm my-4">
          ...
          <div className="flex gap-2 items-center flex-1">
            ...
            <div className="text-lg font-bold">brainsploit@gmail.com</div>
          </div>
        </div>
        ...
        <div className="lg:flex items-center justify-between">
          <div className="text-sm">
            2025 <span className="font-semibold">Brainsploit.</span>.
          </div>
