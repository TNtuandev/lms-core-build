import { CourseFilters, CoursesResponse, CourseDetail, RelatedCoursesResponse, FAQsResponse, ICreateCourseRequest, RelatedCourse, FAQ } from "@/api/types/course.type";
