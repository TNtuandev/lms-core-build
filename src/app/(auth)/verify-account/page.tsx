...
function VerifyAccountPage() {
  ...
  return (
      <div className="flex w-full min-h-screen flex-col lg:flex-row">
        ...
        <div
            className="flex flex-col justify-center items-center w-full lg:w-[50%] xl:w-[40%] px-4 sm:px-6 md:px-8 lg:px-6 xl:px-8 py-8 lg:py-0 min-h-screen">
          {/* Content Container */}
          <div className="w-full max-w-md mx-auto">
            ...
            {error && (
                <div
                    className="bg-red-50 border border-red-200 text-red-600 px-4 py-3 rounded-md text-sm mb-6 text-center">
