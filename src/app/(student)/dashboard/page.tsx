            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 px-4 pb-4 pt-6">
              ...
              <Card className="bg-[#919EAB14] border-0">
                <CardContent className="flex flex-col items-center pt-6">
                  <div className="w-24 h-24 flex items-center justify-center bg-[#FF980029] rounded-xl mb-4">
                    <Profile2User size={24} color="#F44336" />
                  </div>
                  <h3 className="text-5xl font-bold text-[#FF9800]">{teacherData?.data.totalStudents}</h3>
              ...
              <Card className="bg-[#919EAB14] border-0">
                <CardContent className="flex flex-col items-center pt-6">
                  ...
                  <h3 className="text-5xl font-bold text-[#16A1FF]">{teacherData?.data.totalPrices ?? 0}</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 px-4 pb-4 pt-6">
              ...
              <Card className="bg-amber-50 border-0">
                <CardContent className="flex flex-col items-center pt-6">
                  ...
                  <h3 className="text-5xl font-bold text-[#DC7CFD]">{learnerProfileData?.data._totalCoursesInProgress}</h3>
