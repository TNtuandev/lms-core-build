...
export const TERMS_LIST = [
  {
    ...
    content: (
      <>
        Chào mừng bạn đến với Algoki! Bằng cách truy cập và sử dụng trang web của chúng tôi (sau đây gọi là &#34;Website&#34;), bạn đồng ý với các điều khoản và điều kiện dưới đây.
      </>
    )
  },
  {
