    ...
    <section className="bg-white mb-20 md:mb-[120px]">
      <div className="container mx-auto px-6 lg:px-20">
        <div className="text-center lg:text-left max-w-4xl mb-16">
          <h2 className="text-2xl md:text-4xl font-extrabold text-[#0E0F1C] leading-snug mb-4">
            Brainsploit cung cấp cho bạn <br className="hidden md:block" />
            nền tảng và kiến thức bạn cần <br className="hidden md:block" />
            để thành công.
          </h2>
          ...
          <Col xs={24} md={8}>
            <div className="bg-gradient-to-br from-[#edf4ff] to-[#f7f5ff] rounded-2xl shadow-md p-8 text-center h-full flex flex-col justify-center min-h-[336px]">
              <p className="text-[#212B36] font-bold text-2xl leading-relaxed mb-4">
                Brainsploit cung cấp cho bạn nền tảng và kiến thức bạn cần để
                thành công.
              </p>
              ...
              <span className="text-base text-[#212B36]">Brainsploit</span>
            </div>
          </Col>
